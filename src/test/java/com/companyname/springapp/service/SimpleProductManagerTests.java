...
import es.unileon.springapp.repository.ProductDao;
...
public class SimpleProductManagerTests {
    ...
    public void setUp() throws Exception {
        ...
        ProductDao productDao = new InMemoryInvestmentFundDao(products);
    ...
    public void testGetProductsWithNoProducts() {
        productManager = new SimpleProductManager();
        productManager.setProductDao(new InMemoryInvestmentFundDao(null));
    ...
    public void testIncreasePriceWithEmptyListOfProducts() {
        try {
            productManager = new SimpleProductManager();
            productManager.setProductDao(new InMemoryInvestmentFundDao(new ArrayList<Product>()));
